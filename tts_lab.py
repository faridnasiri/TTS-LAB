...
MODEL_INFO = {
    ...
    "outetts":   {"label":"OuteTTS 1.0",   "size":"384 MB (Q4_K_M) / 617 MB (Q8_0)","rtf_est":"RTF 1.45 (GPU)","ram_est_mb":800,  "heavy":True, "notes":"OuteTTS-1.0-0.6B GGUF via LLAMACPP + GPU. Q4_K_M=RTF 1.45, Q8_0=RTF 1.53 — Q4_K_M faster. llama-cpp-python 0.3.20 CUDA. Default: /opt/models/outetts-gguf/OuteTTS-1.0-0.6B-Q4_K_M.gguf","arthur_fit":4},
    ...
    "qwen3tts":   {"label":"Qwen3-TTS",   "size":"~3 GB",    "rtf_est":"RTF ~4.4× (GPU)","ram_est_mb":2000, "heavy":True, "notes":"Qwen3-TTS-12Hz-1.7B-CustomVoice. 9 built-in speakers. attn=sdpa (SM 12.0 Blackwell). All sampling params exposed. Voice clone via ref WAV + transcript.","arthur_fit":3},
