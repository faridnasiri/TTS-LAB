...
function buildEngineTabs() {
  ...
  const keys = ['flux2klein', 'flux2klein9b', 'sd35', 'wan', 'ideogram4'];
  const labels = { flux2klein: 'FLUX.2 Klein', flux2klein9b: 'Klein 9B-KV', sd35: 'SD 3.5 Large', wan: 'Wan2.2', ideogram4: 'Ideogram 4' };
