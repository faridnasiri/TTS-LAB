...
MODEL_INFO = {
    ...
    "speecht5_fa":{"label":"SpeechT5 Persian","size":"144M+13M params","rtf_est":"RTF ~1.0×",        "ram_est_mb":600,  "heavy":False,"notes":"⚠ LOW-QUALITY: Hamid20 fine-tune (4000 steps, val_loss=0.54). Only ~36% non-silent audio. Model limitation — not fixable via params. speechbrain xvector from user ref WAV.","arthur_fit":1},
