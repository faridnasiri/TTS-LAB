...
MODEL_INFO = {
    ...
    "chatterbox": {"label":"Chatterbox",    "size":"3.0 GB",             "rtf_est":"RTF 2.42×",            "ram_est_mb":1800, "heavy":True, "notes":"Exaggeration slider + voice cloning. Pass model:persian for Persian T3.","arthur_fit":5},
